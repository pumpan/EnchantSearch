...
frame:SetScript("OnEvent", function()
    ...
    -- SÖKFÄLT
    -- ======================
searchBox = CreateFrame("EditBox", "EnchantSearchBox", CraftFrame, "BackdropTemplate")
    ...
    -- RESULT FRAME
    -- ======================
resultFrame = CreateFrame("Frame", "EnchantSearchResults", CraftFrame, "BackdropTemplate")
            ...
            if name and craftType ~= "header" then
                if string.find(string.lower(name), text, 1, true) then
                    ...
                    if CraftColorInfo[craftType] then
						...
						btn.colorBar:SetColorTexture(c.r, c.g, c.b, 0.9)
						btn.colorBar:Show()
